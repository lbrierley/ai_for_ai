...
# Set parallelisation - to disable, comment out, and change %dopar% in line 104 to %do%
...
svm_fun <- function(subtype){
  ...
  # Train and validate radial SVM (tuning sigma, C, weight parameters) through 5-fold cross-validation
